"use client";
// TODO: Connect to Supabase — Deferred
// Write operations (addLot → item_lots, update purchase_orders status) require
// stable DB schema + row-level security. Keep using AppContext local state for now.
